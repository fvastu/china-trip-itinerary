      ...
      <div className="mt-10 space-y-12">
        ...
        <DayCard
          ...
          items={[
            ...
            { time: "Cena", icon: "food", title: "Cena nel Quartiere — Roujiamo & Biang Biang Mian", highlight: true,
              description: "Roujiamo da TAJIA LAZHI ROUJIAMO · Biang Biang Mian da ZHENGZONG KUDAI MIAN · Pane nel brodo di agnello: YONG SHENG ZHAI · Tè tipico: ZONG QING SHAN.",
        ...
        <DayCard
          ...
          items={[
            ...
            { time: "14:00–18:00", icon: "place", title: "Dayan Pagoda e Parco 大雁塔", highlight: true,
              description: "¥50 ingresso tempio + parco. ¥30 extra per salire sulla pagoda. Biglietti al momento.",
              attraction: A.dayanPagoda },
            { time: "~19:30", icon: "place", title: "Spettacolo Fontane Musicali", highlight: true,
              description: "North Square. Gratuito, ~20 min. Orario indicato in loco. Le più grandi fontane musicali dell'Asia.",
              attraction: A.fontane },
            { time: "Cena", icon: "food", title: "Qin Yu Rou Jia Mo o Zi Wu Lu Zhang Ji Rou Jia Mo", description: "Quest'ultimo consigliato per posizione rispetto all'hotel. Zona tranquilla." },
